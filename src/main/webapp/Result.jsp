...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
            <%@page import="oqs.model.QuestionsDao"%>
<%@page import="oqs.db.*"%>
...
if(session.getAttribute("name")==null)
	{
	String msg = "!! Please Login as User to Continue !!";
	response.sendRedirect("StudentLogin.jsp?msgRed="+msg);
...
<table class="table table-hover">
  <thead >
    <tr class="table-warning">
      <th colspan="3" scope="col"><center><pre><h4>Name :- <%=session.getAttribute("name") %>  || Emailid :- <%=session.getAttribute("Email") %></h4></pre></center></th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<center>
<input  onclick="location.href='controller.LogoutStudent'" type="button" value="Exit" class="btn btn-outline-danger btn-lg">
</center>
<%} %>
</body>
</html>