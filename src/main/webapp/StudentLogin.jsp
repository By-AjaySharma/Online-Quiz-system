...
<body>
<center>
	<font color="blue"><h1>User Login</h1></font>
	<font color="red" >
		<%
	...
	<form action="controller.ValidateStudent" method="post" style="margin-left:auto;margin-right:auto;width:500px;">
		<pre>
	User Id     :	<input type="text" name="uname" placeholder="Enter EmailId">	 <br>
