...
import oqs.db.Instructions;
import oqs.model.InstructionsDao;
...
public class InstructionInsert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
	    	...
	    	response.sendRedirect("AddInstruction.jsp?msgGreen="+msg1);
		}
		else
		{
			String msg2 = "!! Instruction not Added !!";
	    	response.sendRedirect("AddInstruction.jsp?msgRed="+msg2);
		}
